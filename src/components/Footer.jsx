...
<footer id='footer' className="bg-black dark:bg-white">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-black dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">ShopMe™</a>. All Rights Reserved.
        </span>
